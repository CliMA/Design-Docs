...
\medskip
\noindent{\bf Try 1:} $\rho^{*}_{1} = \rho^{*}_{2} = 0$.\\
...
\medskip
\noindent{\bf Try 2:} $\rho^{*}_{1} = \rho^{*}_{2} = \rho^{-}/2$.\\
...
\noindent{\bf Try 3:} $\rho^{*}_{1} = \rho^{-}/2$ and $\rho^{*}_{2} = 0$.\\
This choice is essentially saying that we will use an average of the internal
...
diffusive variables $\vec{\Sigma}$ to satisfy the governing equations
