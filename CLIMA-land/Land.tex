...
\begin{tabular}{llll}
\hline
Variables & Description                      & Units     & Range [if relevant] \\ \hline
$f_{om}$   & organic matter fraction &           &                         \\
... &   &  & \\
... &   &  & \\
... &   &  & \\
... &   &  & 
...
\begin{tabular}{lllll}
\hline
Variables & Description                      & Units     & Range [if relevant] & Example value (if relevant)\\ \hline
$\theta$       & Relative Water Content                    & $m^3/m^3$ & 0 - 1       & N/A \\
$K$   & Hydraulic Conductivity &   $m/s$        &    0 - $\infty$    \\
$K_{sat}$   & Saturated Hydraulic Conductivity &   $m/s$        &    0 - $\infty$                     \\
$S$       & Water Storage                    & $m^3/m^3$ & 0 - 1        \\
$S_{y}$       & Unconfined Aquifer Specific Yield   & $m^3/m^3$ &  0 - 1       \\
$n$       & Porosity   & $m^3/m^3$  &   0 - 1      \\
$S_{s}$       & Aquifer Storativity   & $m^3/m^3$ &  0 - 1       \\
$b$       & Aquifer Thickness  & $m$ &  0 - $\infty$        \\
$h$       & Hydraulic Head  & $m$ &  $-\infty$ - $\infty$        \\
$z$       & Height  & $m$ &  0 - $\infty$        \\
$\psi$       & Matric Potential  & $m$ &  $-\infty$ - $\infty$        \\
$\bold{q}$       & Darcy's Flow  & $m^3/s$ &  0 - $\infty$        \\
... &   &  & \\
$\theta_{r}$       & Residual Water Content   & $m^3/m^3$ & 0 - 1       & 0.05 \\
$\theta_{s}$       & Saturated Water Content   & $m^3/m^3$ & 0 - 1       & 0.45 \\
$\alpha$   & VG Scale Parameter for Retention Function & $cm^{-1}$ & 1e$^{-6}$ - 1e$^{-4}$  & 1e$^{-5}$ \\
