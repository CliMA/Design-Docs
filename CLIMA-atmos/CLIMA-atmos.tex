...
\be
\diff{}{\vec{x_{1}}} \vec{Y}^{(e)}_N(\xi_{1},\xi_{2},t) = \diff{}{\vec{x_{1}}} \sum_{i=1}^{N_{\xi_{1}}+1} \sum_{j=1}^{N_{\xi_{2}}+1} h_i(\xi_{1}) h_j(\xi_{2}) \vec{Y}^{(e)}_{ij}(t)
...
\be
\diff{}{x_{1}} \vec{Y}^{(e)}_N(\xi_{1},\xi_{2},t) = \sum_{i=1}^{N_{\xi_{1}}+1} \sum_{j=1}^{N_{\xi_{2}}+1} \left( \diff{h_i(\xi_{1})}{\xi_{1}}\diff{\xi_{1}}{x_{1}} h_j(\xi_{2}) + h_i(\xi_{1}) \diff{h_j(\xi_{2})}{\xi_{2}}\diff{\xi_{2}}{x_{1}} \right) \vec{Y}^{(e)}_{ij}(t).
...
\be
\diff{}{x_{1}} \vec{Y}^{(e)}_N(\xi_{1}, \xi_{2}, \xi_{3}, t) = \sum_{i=1}^{N+1} \sum_{j=1}^{N+1} \sum_{k=1}^{N+1} \left( dh_i \xi_x h_j h_k + h_i dh_j h_k \eta_x + h_i h_j dh_k \zeta_x\right) \vec{Y}^{(e)}_{ijk}(t).
